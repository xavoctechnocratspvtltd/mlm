...
CREATE TABLE `mlm_payout` (
  ...
  `actual_generation_a_business` int(11) DEFAULT '0',
  `actual_generation_b_business` int(11) DEFAULT '0',
  `generation_a_business` int(11) DEFAULT '0',
  `generation_b_business` int(11) DEFAULT '0',
