...
class Model_Order_Topup extends \xavoc\mlm\Model_SalesOrder {
	...
	function page_verify_Payment($page){
		...
		foreach ($field_list as $key => $field) {
			$form->add('View')->setHtml(strtoupper($field).': <strong>'.$th[$field].'</strong>');
		}
