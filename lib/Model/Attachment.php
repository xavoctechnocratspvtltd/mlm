...
class Model_Attachment extends \xepan\base\Model_Table {
	...
	function init(){
		...
		$this->add('xepan\filestore\Field_Image','id_proof_id');//->caption('Upload Your Aadhar Card');
		$this->add('xepan\filestore\Field_Image','address_proof_id');//->caption('Upload Your Aadhar Card');
		$this->add('xepan\filestore\Field_Image','cancelled_cheque_id');//->caption('Upload Your Pan Card');
