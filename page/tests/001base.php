...
class page_tests_001base extends page_Tester {
    ...
    function test_company_record(){
        $data = [
        'ram'=>['sponsor'=>'company','introducer'=>'company','on'=>'2017-05-07'],
        // 'kit-ram'=>'kit name',
        // 'green-0a'=>'date',
    ...
    function prepare_company_record(){
        $this->proper_responses['test_company_record']=[
            ['name'=>'Company','path'=>'0','sponsor'=>null,'introducer'=>null,'kit'=>null,'introAmount'=>0,'leftSv' => 0,'rightSv' => 0,'leftDP'=>0,'rightDP'=>0,'totalPairs'=>0,'carriedAmount'=>0,'greenedOn'=>null,'joinedOn'=>'2017-05-07'],
