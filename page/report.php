...
class page_report extends \xepan\base\Page {
	...
	function setLeftMenu(){
		...
		$this->app->side_menu->addItem(['Distributor List','icon'=>'fa fa-circle-o','badge'=>[0,'swatch'=>' label label-primary label-circle pull-right']],$this->app->url('xavoc_dm_report_distributorlist'))->setAttr(['title'=>'Distributor List']);
